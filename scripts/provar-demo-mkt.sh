#!/usr/bin/env bash
#
# O formulario de DEMO (MKT-007) e a conversao, medidos antes e depois.
#
...
#
#   ./scripts/provar-demo-mkt.sh antes | depois | (nada)
#
...
FASE="${1:-}"
DESTINO="docs/visual/rv100/2026-09-06_e953a87/evidence/demo"
naomedi() { printf '  NAO MEDI %s\n' "$1"; exit 2; }

case "$FASE" in ''|antes|depois) ;; *) naomedi "fase '$FASE' desconhecida" ;; esac
[ -f inspeccao/rv100-demo.spec.ts ] || naomedi "o instrumento nao esta em inspeccao/"
