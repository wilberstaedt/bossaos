...
export default defineConfig({
  ...
  projects: [
    { name: 'preparar', testMatch: /autenticar\.setup\.ts/ },
    {
      ...
      testIgnore: [/autenticar\.setup\.ts/, /painel\.spec\.ts/, /isolamento\.spec\.ts/, /tema\.spec\.ts/, /sala\.spec\.ts/, /pedidos\.spec\.ts/, /staff\.spec\.ts/, /staff-telas\.spec\.ts/],
    ...
    },
    {
      ...
      testMatch: [/painel\.spec\.ts/, /isolamento\.spec\.ts/, /tema\.spec\.ts/, /sala\.spec\.ts/, /pedidos\.spec\.ts/, /staff\.spec\.ts/, /staff-telas\.spec\.ts/],
