...
export default defineConfig({
  ...
  projects: [
    { name: 'preparar', testMatch: /autenticar\.setup\.ts/ },
    {
      ...
      testIgnore: [/autenticar\.setup\.ts/, /painel\.spec\.ts/, /isolamento\.spec\.ts/, /tema\.spec\.ts/, /sala\.spec\.ts/, /pedidos\.spec\.ts/, /staff\.spec\.ts/, /staff-telas\.spec\.ts/, /kds\.spec\.ts/, /visitante\.spec\.ts/, /reservas\.spec\.ts/, /host\.spec\.ts/, /mensagens\.spec\.ts/, /levar\.spec\.ts/, /tpv\.spec\.ts/, /portas\.spec\.ts/, /pagamentos\.spec\.ts/, /fiscal\.spec\.ts/, /stock\.spec\.ts/, /compras\.spec\.ts/, /crm\.spec\.ts/, /ponto\.spec\.ts/, /financeiro\.spec\.ts/, /analitica\.spec\.ts/, /kiosk\.spec\.ts/, /integracoes\.spec\.ts/, /plataforma\.spec\.ts/, /expansao\.spec\.ts/, /alcance\.spec\.ts/, /id-de-rota\.spec\.ts/, /tipografia-minima\.spec\.ts/, /superficies\.spec\.ts/, /foco\.spec\.ts/, /ns2-mesas\.spec\.ts/],
