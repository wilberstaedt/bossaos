...
| E09 | implementado, aguardando validação | docs/progress/E09.md · 3 migrações (endereço público, consultas, portas do público) · **projecção por lista de permissão** — um campo novo no retrato é invisível por omissão · **QR real** com Reed-Solomon, verificado por quatro medidas independentes · a quarta porta do CT-04, que faltava desde o E07 · chave de cache com unidade, publicação, idioma e canal · `menu_views` sem coluna para seguir ninguém · 294 asserções no domínio + 23 contra a base, 8 controlos negativos · retido à 1ª: o detector de verbos via uma só forma de exportação · e o endereço público que não volta ao mundo (`@unique` impede dois ao mesmo tempo, não dois em sequência) · 11 telas |
| E10 | planejado |  |
| E11 | planejado |  |
| E12 | planejado |  |
| E13 | planejado |  |
