...
| E12 | implementado aguardando validação | **assinatura RETIRADA 04/09** · validei sobre um verde LOCAL que a CI contradiz em três corridas seguidas: `tema.spec.ts` falha com «o servidor aceitou um par ilegível», que é o aceite 2 · hipótese medida a meio: a prova exige inquilino **Pro** (o próprio spec o diz na linha 331) e a semeadura **não define plano**, portanto na base fresca da CI o portão do plano dispara antes do contraste · a corrigir: a prova estabelece o plano em vez de o herdar |
| E13 | planejado |  |
| E14 | planejado |  |
| E15 | planejado |  |
| E16 | planejado |  |
