...
| E10 | implementado aguardando validação | docs/progress/E10.md · **as 29 telas**, medidas no navegador em cinco larguras (transbordo, elementos fora do ecrã, alvos de toque a 44 px, contraste) · provar-sites.sh: 3 grupos, 27 casos, **sete** controlos negativos, um por cada defeito que a régua nomeia — incluindo partir a gravação do lead a valer, retirando o INSERT ao runtime · o arnês passou a autenticar com sessão real, e isso fechou a dívida de móvel do E09 · cinco defeitos apanhados pela prova de navegador, nenhum do código novo sozinho (itens de grelha que crescem com o conteúdo; margin auto a desligar o esticar; o QR de 320 px fixos; um telefone a 130×23; a landing no tubo de 640 px da carta) · sem preços na página de planos e sem sincronização com o Google, os dois declarados |
| E11 | planejado |  |
| E12 | planejado |  |
| E13 | planejado |  |
| E14 | planejado |  |
