...
| E09 | validado | docs/progress/E09.md · provar-publico.sh: 11 passos, 23 asserções, **oito** controlos negativos · retido uma vez pela detecção de verbo que só via uma forma de escrever POST, fechada com onze formas · endereço público que não volta ao mundo, com o par que o separa da regra preguiçosa (o dono retoma) · 18 migrações do zero · **ASSINATURA PARCIAL**: 6 das 11 telas renderizadas e medidas; as outras 5 (CHAN-001, QR-001/003/004, REP-001) exigem sessão no navegador e a assinatura foi RETIRADA quanto à tela — bloqueante para o E11 |
| E10 | **em curso (parado por contexto)** | docs/progress/E10.md · nenhuma das 29 telas começada · arnês do navegador com semeadura · 6 das 11 telas da dívida do E09 medidas (34 verificações) · dois defeitos reais encontrados: a carta pública sem folha de estilos, e  a servir o menu de outra unidade · por fechar: semeadura sem teardown, 3 verificações por diagnosticar, 5 telas que exigem sessão |
| E11 | planejado |  |
| E12 | planejado |  |
| E13 | planejado |  |
| E14 | planejado |  |
