...
| E08 | **em curso** | docs/progress/E08.md · sete motores puros commitados (`0d1a833`, `0be0f9c`): CSV que se neutraliza contra fórmulas, endereços que recusam a rede interna, tipo de ficheiro pelos bytes (o SVG é um documento), traduções que ficam obsoletas quando a origem muda, publicação que bloqueia em vez de inventar, importação que nunca funde por nome, exportação verificada duas vezes · **74 asserções, 23 controlos negativos** · falta schema, serviços, 10 telas e prova |
| E09 | planejado |  |
| E10 | planejado |  |
| E11 | planejado |  |
| E12 | planejado |  |
