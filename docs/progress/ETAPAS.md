...
| E09 | **em curso** | docs/progress/E09.md · projecção pública por **lista de permissão** e não de exclusão — um campo novo no retrato é invisível por omissão · 14 asserções, 4 controlos negativos · e o buraco do E08 que ela fez aparecer: a revisão levava produtos ocultos no canal, fechado com o controlo 9e · falta QR, cache, schema, 11 telas e prova |
| E10 | planejado |  |
| E11 | planejado |  |
| E12 | planejado |  |
| E13 | planejado |  |
