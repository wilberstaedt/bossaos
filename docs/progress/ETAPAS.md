...
| E03 | implementado aguardando validação | docs/progress/E03.md · migração 20260903112852_e03_multi_inquilino · 85 testes unitários + 28 asserções na prova de isolamento com controlo negativo (RLS desligado -> vermelho) · zero telas, coverage intacto |
| E04 | planejado |  |
| E05 | planejado |  |
| E06 | planejado |  |
| E07 | planejado |  |
