...
| E12 | validado | docs/progress/E12.md · **passou à primeira** · provar-tema.sh com **7** controlos negativos — portão do plano, contraste, tokens não temáveis, CSS injectado, **fuso da unidade** e **imutabilidade das revisões** · provar-tema-no-navegador.sh com 21 casos e a cor **calculada** na carta e no site · três ataques do revisor: plano no serviço com 402≠403, `DELETE` em theme_revisions recusado pela base, e o tema **contido** em `.bo-publico` |
| E13 | planejado |  |
| E14 | planejado |  |
| E15 | planejado |  |
| E16 | planejado |  |
