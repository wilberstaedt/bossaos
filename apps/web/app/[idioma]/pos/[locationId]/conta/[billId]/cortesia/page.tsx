...
/**
 * POS-011 · a alçada, o motivo e o que NÃO se reescreve.
 *
 ...
 */
export default async function AjusteCORTESIA({
  params,
    ...
    <div className="bo-staff">
      <div className="bo-estado__cabecalho">
        <div>
          ...
          <h1 data-tela="POS-011">{t.cortesia}</h1>
        </div>
      </div>
      ...
      <form method="post" action={`/api/org/${orgSlug}/tpv`} className="bo-forma">
        ...
        <input type="hidden" name="tipo" value="CORTESIA" />
