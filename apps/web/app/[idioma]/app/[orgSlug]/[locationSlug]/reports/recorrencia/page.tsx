...
/**
 * REP-014 · «Conoce la recurrencia» (atlas)
 *
    ...
    <div className="bo-pagina">
      <div className="bo-estado__cabecalho">
        <div>
          ...
          <h1 data-tela="REP-014">{t.recorrencia}</h1>
        </div>
      </div>
      <p data-teste="ausencia-nao-e-zero">{t.ausenciaNaoEZero}</p>
      <p data-teste="definicao">{t.definicao}: {t.visitas}</p>
      ...
      {r.medido ? (
        <>
          ...
          <ul className="bo-lista bo-lista--colunas" data-teste="linhas">
            {r.valor.map((l, i) => (
              <li key={i}>
                <span data-teste="visitas">{l.visitas}</span>
