...
/**
 * REP-011 · «Estado de los pagos» (atlas)
 *
    ...
    <div className="bo-pagina">
      <div className="bo-estado__cabecalho">
        <div>
          ...
          <h1 data-tela="REP-011">{t.pagamentos}</h1>
        </div>
      </div>
      <p data-teste="ausencia-nao-e-zero">{t.ausenciaNaoEZero}</p>
      <p data-teste="definicao">{t.definicao}: {t.estado}</p>
      ...
      {r.medido ? (
        <>
          ...
          <ul className="bo-lista bo-lista--colunas" data-teste="linhas">
            {r.valor.map((l, i) => (
              <li key={i}>
                <span data-teste="estado">{l.estado}</span>
