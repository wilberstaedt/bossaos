...
/**
 * O que as telas de takeaway e entrega carregam, e carregam igual.
 *
 * Mesma decisão do `pedido-da-pagina.ts`: a unidade de outra organização dá
 * **ausência**, porque a diferença entre 404 e «proibido» é um oráculo de
 * existência.
 */
export async function carregarLevar(idioma: string, orgSlug: string, locationSlug: string) {
